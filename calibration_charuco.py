...
images = glob.glob('E:\codeRepos\markerTracking\Aruco_Tracker\calib_images\charuco\*.jpg')
# 获取所有图片
...
# img_board = CHARUCO_BOARD.draw(outSize=(1800, 2500), marginSize=10, borderBits=1)
# cv2.imwrite(filename='charucomy.png', img=img_board, params=None)
